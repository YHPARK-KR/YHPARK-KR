...
<p align="center">
  ...
  정치 데이터의 양적 분석에서 데이터에 눈을 떴고, 철학 존재론(Ontology)에서 세계를 분류하는 훈련을 했습니다.<br/>
  도면 위에서 같은 일을 다시 했을 때 — 분류 체계를 고치자 AI가 작동했습니다.
</p>
...
2025~2026  SSAFY 14기 부울경 (풀스택 + AI Foundation Model)
           경북대 정치외교학(주) + 철학(부) — 선거·정책 데이터 양적 분석 + 존재론 개념 구조화
```
